...
export const PRODUCTS: IProduct[] = [
  {
    ...
    stock: 20,
    imagen: "/assets/products/pizza-muzzarella.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 15,
    imagen: "/assets/products/pizza-napolitana.webp",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 10,
    imagen: "/assets/products/pizza-cuatro-quesos.webp",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 30,
    imagen: "/assets/products/hamburguesa-clasica.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/assets/products/hamburguesa-bbq-bacon.webp",
    disponible: true,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/assets/products/hamburguesa-veggie.webp",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/assets/products/coca-cola-500ml.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 40,
    imagen: "/assets/products/jugo-naranja-natural.webp",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 150,
    imagen: "/assets/products/agua-mineral-500ml.webp",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 12,
    imagen: "/assets/products/torta-rogel.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/assets/products/helado-artesanal-dos-gustos.webp",
    disponible: true,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/assets/products/brownie-con-helado.webp",
    disponible: false,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/assets/products/empanadas-carne.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/assets/products/empanadas-pollo.webp",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/assets/products/empanadas-jamon-queso.webp",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 20,
    imagen: "/assets/products/ensalada-cesar.webp",
    disponible: true,
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/assets/products/ensalada-caprese.webp",
    disponible: true,
    categorias: [categorias[5]],
  },
  {
    ...
    stock: 10,
    imagen: "/assets/products/pizza-fugazzeta.webp",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 0,
    imagen: "/assets/products/hamburguesa-crispy.webp",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 25,
    imagen: "/assets/products/ensalada-mixta.webp",
    disponible: true,
    categorias: [categorias[5]],
  },
]
